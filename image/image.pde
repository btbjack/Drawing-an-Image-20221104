...
void setup() 
{
  ...
  //
  //Population
  pic1 = loadImage("../Images Used/Landscape/FIFA-2022-Background-HD-Wallpapers-126306.jpg");
  pic2 = loadImage("../Images Used/Landscape/Pep-Guardiola-Trent.jpg");
  pic3 = loadImage("../Images Used/New folder/Trent-Liverpool.jpg");
  ...
  bottomX = appWidth * 1/2;
   ...
   int picWidth1 = 500; //World Cup image
  int picHeight1 = 350;
  int picWidth2 = 30; //Trent and Pep image
  int picHeight2 = 40;
  int picWidth3 = 100; //Trent image
  int picHeight3 = 70;
  //
