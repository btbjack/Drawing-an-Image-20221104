...
float  topX, topY, topWidth, topHeight, bottomX, bottomY, bottomWidth, bottonHeight;
//
void setup() {
  ...
  if ( picWidth2 >= picHeight2 ) { //True if Landscape or Square
    ...
    println("here", picWidthAdjusted2, picHeightAdjusted);
  } else { //False if Portrait
  ...
  pic2 = loadImage("../Images Used/Landscape/fifa.jpg");
...
void draw() {
  ...
  image(pic3, bottomX, bottomY, bottomWidth, bottonHeight);
}//End draw
//
void keyPressed() {
}//End keyPressed
